...
public class GoodsSkuSaveParam implements Serializable {
    ...
    @Schema(description = "attrValueJson", requiredMode = AUTO, example = "{}")
    ...
    @Schema(description = "Default sku", requiredMode = AUTO, example = "0/1")
