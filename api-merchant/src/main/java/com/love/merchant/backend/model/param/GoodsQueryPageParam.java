...
public class GoodsQueryPageParam extends PageParam {
    ...
    @Schema(description = "Merchant id(which merchant you want to search)", hidden = true)
    private Long userId;
    ...
    @Schema(description = "Goods type(1: physical goods, 2: Digital goods)", requiredMode = REQUIRED, example = "1")
